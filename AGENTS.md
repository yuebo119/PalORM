...
| **高** | `.ai/lessons.md` | 规范系统手册 v7.17（119 缺陷：A1-A7 + B1-B112 + XI 性能测量纪律 SOP，本地工具，不入仓库） |
| **高** | `.ai/test/prompt.md` | 测试规范系统 v1.2（23 铁律 + 19 缺陷，本地工具，不入仓库） |
...
| `/test` | 测试规范 | T1-T23 测试铁律 + 覆盖矩阵 + 基准配置规范 |
